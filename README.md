...
所有数据存储在项目根目录的 `.todolist.db` 文件中（SQLite 数据库）。
...
你: 我今天晚上5点要回家和小羊吃饭，下午需要完成论文的pre和ppt，早上需要处理工作上的事情
Agent: 已成功为你添加以下待办事项：

1. **ID: 10** - 处理工作上的事情（工作类，高优先级）  
2. **ID: 11** - 完成论文pre（学习类，高优先级）  
3. **ID: 12** - 制作并完善论文PPT（学习类，高优先级）  
4. **ID: 13** - 回家和小羊吃饭（生活类，中优先级，备注：晚上5点准时出发）
